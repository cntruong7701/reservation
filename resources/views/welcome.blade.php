                ...
                <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
                    <div class="w-full lg:max-w-md">
                        ...
                        <p class="mb-4 font-medium tracking-tight text-gray-400 xl:mb-6">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus hic atque magni minus
                            aliquam, eos quam incidunt nam iusto sunt
                            voluptates inventore a veritatis doloremque corrupti. Veritatis est expedita cupiditate!
                        </p>
                        <ul>
    ...
    <section class="pt-4 pb-12 bg-gray-800">
        <div class="my-16 text-center">
            ...
            <p class="text-xl text-white">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. soluta sapient
            </p>
        </div>
        <div class="grid gap-2 lg:grid-cols-3 mx-auto container">
