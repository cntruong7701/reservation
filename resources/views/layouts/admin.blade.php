        ...
        <main class="m-2 p-8 w-full">
            <div class="">
                @if (session()->has('danger'))
                    <div
                        class="flex bg-white flex-row shadow-md border border-gray-100 rounded-lg overflow-hidden md:w-5/12">
                        <div class="flex w-3 bg-gradient-to-t from-red-500 to-red-400"></div>
                        <div class="flex-1 p-3">
                            <h1 class="md:text-xl text-gray-600">Danger</h1>
                            <p class="text-gray-400 text-xs md:text-sm font-light">{{ session()->get('danger') }}</p>
                        </div>
                    </div>
                @endif
                @if (session()->has('success'))
                    <div
                        ...
                        <div class="flex-1 p-3">
                            ...
                            <p class="text-gray-400 text-xs md:text-sm font-light">{{ session()->get('success') }}</p>
                        </div>
                    </div>
                @endif
